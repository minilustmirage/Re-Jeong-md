...
let botname = process.env.BOTNAME || 'denji;

const owner = process.env.DEV || '0555581921'; // This will send a notification once the bot reconnects
const {
