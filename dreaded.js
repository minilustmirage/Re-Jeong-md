...
const botname = process.env.BOTNAME || 'denji;
const antibot = process.env.ANTIBOT || 'FALSE';
    ...
    const author = process.env.STICKER_AUTHOR ||'benji;
    const packname = process.env.STICKER_PACKNAME || 'benji;
const dev = process.env.DEV || '2250555581921';
...
function _0x2de4() {
    const _0xca7309 = [
        ...
        'catch',
        'e\x20text.\x20Th',
        '\x20of\x20its developer Re-Jeong Guanxii',
        'is\x20AI\x20work',
        '1832596QZCVhJ',
        '\x20and\x20Googl',
        'AgaVJ',
...
let xf = m.quoted.text;
                ...
                let pppuser = await client.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/019207dd7bf306d343b7e.jpg')
...
`👋🏻 Hello *${pushname}*,You can deploy Re-Jeong bot using the GitHub link below\n\nFork and give us a star✨.\n\n https://github.com/Re-Jeong01/Re-Jeong-md\n\nAfter uploading the document connect your repo with this link and deploy\nhttps://dashboard.heroku.com/new-app?template=https://github.com/Re-Jeong01/Re-Jeong-md\n\nEnjoy and have fun with me😜!\n\nMy owner is Re-Jeong Guanxii!` });
 ...
 break;
          case "leave": { 
                 if (!isAdmin) throw admin; 
 await client.sendText(m.chat, 'GoodBye Everyone🥲. Re-Jeong is leaving now Guess we will never meet again..😔'); 
...
case "ping": case "speed": {
 ...
 case "runtime": case "uptime": { 
                 m.reply (`Re-Jeong is active for ${runtime(process.uptime())}`) 
 } 
 break;
...
client.sendMessage(from, buttonMessage, { quoted: m }) 
 ...
 break 
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `*_Converted by Re-Jeong_*`}, { quoted: m }) 
...
case "movie": 
 ...
 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/019207dd7bf306d343b7e.jpg' }, caption: `Don't Dm for no reason 💀 here is my owner's contact +27623649420 💀` }, {quoted: m}); 
 ...
 break;
    ...
    break;
         ...
         for (let i of res) { 
             let txt = `*_</ Re-Jeong Broadcast >\n\n🀄 Message: ${text}\n\nAuthor: ${pushname}_*` 
             await client.sendMessage(i, { 
                 image: { 
                     url: "https://telegra.ph/file/019207dd7bf306d343b7e.jpg" 
                 }, 
                 caption: `${txt}` 
             }) 
         } 
